...
class DocenteDAO:
  ...
  def _obtener_conexion(self):
    ...
    conexion.row_factory = (
        sqlite3.Row
    )  # Permite acceder a columnas por su nombre
    return conexion
...
# ==============================================================================
# CÓDIGO DE PRUEBA / REGISTRO DE DOCENTE
# ==============================================================================
if __name__ == "__main__":
  ...
  # 3. Crear el objeto Docente con los datos a registrar
  ...
  # 4. Insertar el registro en la base de datos
  if dao.insertar(nuevo_docente):
    print(
        f"✅ ¡Docente registrado con éxito! ID asignado:"
        f" {nuevo_docente.id_docente}"
    )
  else:
    print("❌ No se pudo registrar el docente.")